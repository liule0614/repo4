...
import com.migration.dao.DBADao;
import com.migration.domin.Task;
import com.migration.thread.DBAThread;
...
public class DBAService {
    ...
    public List<Map> showDataBase() {
        List<Map> list = dao.showDataBase();
        return list;
    }

    public Map queryIpSource(Integer id) {
        Map map = dao.queryIpSource(id);
