...
public class MQReceiver {
	...
	public void receiveMiaosha(String message) {
		log.info("receive message: miaosha"+message);
		MiaoshaMessage msg = RedisService.stringToBean(message, MiaoshaMessage.class);

		GoodsVo goods = this.goodsService.queryGoodsByGoodsId(msg.getGoodsId());
		this.miaoshaService.miaosha(msg.getUser(),goods);
